...
{
    class PostManAPI
    {   private static string soapURL = "http://114.80.200.100:8081/axis2/services/yc.ycHttpSoap11Endpoint/";
        private static string WSDLURL = "http://114.80.200.100:8081/axis2/services/yc?wsdl";
        ...
        public static XmlDocument sendsms(String username, String password, String message, String target, String ext, String send_time)
        {
            string soapStr = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:yc=\"http://yc\" xmlns:xsd=\"http://yc/xsd\">"
					   ...
					   "<yc:password>"+MD5(password)+"</yc:password>" +
					   "<yc:_SendRequset>" +
					   "<xsd:ext>"+ext+"</xsd:ext>" +
					   ...
					   "</soapenv:Body>" +
					   "</soapenv:Envelope>";
            return WebSrvCaller.QuerySoapWebService(soapURL, "checkBalance", null, WSDLURL, soapStr);
        }
        ...
        public static XmlDocument checkBalance(string username, string password)
        {
            ...
            parsQ.Enqueue(new DictionaryEntry("password", MD5(password)));
